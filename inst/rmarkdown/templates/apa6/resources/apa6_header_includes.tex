...
\@ifundefined{hrm}{}{\hrm}
 \check@author
  ...
  \vspace*{1in}
  \@title \@ifundefined{def@draftall}{}{\[DRAFT\]}%
  \ifapamodeman{%
    \@ifundefined{def@noextraspace}{%
      \vspace{0.25in}\\
    }{
...
\fancypagestyle{titlepage}{%
    \lhead{\rheadname: \addfontfeatures{Numbers=Uppercase}\MakeUppercase{\@shorttitle} \@ifundefined{def@draftall}{}{\[DRAFT\]}}%
    \rhead{\thepage}%
}
\fancypagestyle{otherpage}{%
    \lhead{\addfontfeatures{Numbers=Uppercase}\MakeUppercase{\@shorttitle} \@ifundefined{def@draftall}{}{\[DRAFT\]}}%
    \rhead{\thepage}%
}
\pagestyle{otherpage}
}
