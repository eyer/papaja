...
\ifapamodeman{%
  \@ifundefined{def@noextraspace}{}{%
    ...
    \b@level@one@skip=0ex \@plus 0ex \@minus 0ex
    \e@level@one@skip=0ex \@plus 0ex \@minus 0ex
    \b@level@two@skip=0ex \@plus 0ex \@minus 0ex
    \e@level@two@skip=0ex \@plus 0ex \@minus 0ex
    \b@level@three@skip=0ex \@plus 0ex \@minus 0ex
    \e@level@three@skip=-\z@
    \b@level@four@skip=0ex \@plus 0ex \@minus 0ex
    \e@level@four@skip=-\z@
    \b@level@five@skip=0ex \@plus 0ex \@minus 0ex
