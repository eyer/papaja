...
\ifapamodeman{%
  \@ifundefined{def@noextraspace}{}{%
    ...
    \b@level@one@skip=0\baselineskip \@plus 0.2ex \@minus 0.2ex
    \e@level@one@skip=0\baselineskip \@plus .2ex
    \b@level@two@skip=0\baselineskip \@plus 0.2ex \@minus 0.2ex
    \e@level@two@skip=0\baselineskip \@plus 0.2ex
