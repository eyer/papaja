...
\ifapamodeman{%
  \@ifundefined{def@noextraspace}{}{%
    ...
    \b@level@one@skip=\baselineskip \@plus 0.2ex \@minus 0.2ex
    \e@level@one@skip=\baselineskip \@plus .2ex
    \b@level@two@skip=\baselineskip \@plus 0.2ex \@minus 0.2ex
    \e@level@two@skip=\baselineskip \@plus 0.2ex
